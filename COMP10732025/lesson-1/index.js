/*
		...
		*/
        ...
        function updateName(){
			...
			let firstName = yk			// STEP 4b: Grab the input from the variable and build a new string, then change the text inside the EM element, using the textContent property
        }
